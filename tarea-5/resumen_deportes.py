...
def crear_prompts(titulo_pagina: str, texto_limpio: str) -> list:
    """Crea los prompts para el modelo de Ollama"""
...
def obtener_html(url: str) -> str:
    """Descarga el HTML de la URL con manejo de errores"""
...
def limpiar_y_extraer_texto(html_content: str) -> tuple[str, str]:
    """Limpia el HTML y extrae el texto del cuerpo"""
    if not html_content:
        return "", ""
...
def guardar_resumen(url: str, resumen_texto: str):
    """Guarda el resumen a archivo.md con marca temporal"""
...
def procesar_url(url: str):
    """Función principal que lanza el script."""
